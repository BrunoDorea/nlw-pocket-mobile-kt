package br.com.brunodorea.nearby.core.network

import br.com.brunodorea.nearby.core.network.KtorHttpClient.httpClientAndroid
import br.com.brunodorea.nearby.data.model.Category
import br.com.brunodorea.nearby.data.model.Coupon
import br.com.brunodorea.nearby.data.model.Market
import br.com.brunodorea.nearby.data.model.MarketDetails
...
object NearbyRemoteDataSource {
    ...
    private const val LOCAL_HOST_PHYSICAL_BASE_URL = "http://192.168.100.7:3333"
