package br.com.brunodorea.nearby.ui.screen.qrcode_scanner
...
import br.com.brunodorea.nearby.MainActivity
...
fun QRCodeScannerScreen(modifier: Modifier = Modifier, onCompletedScan: (String) -> Unit) {
    ...
    fun checkCameraPermission() {
        if (ContextCompat.checkSelfPermission(
            ...
            Toast.makeText(
                context, "Necessário permitir o acesso à câmera para continuar.", Toast.LENGTH_SHORT
            ).show()
        } else {
